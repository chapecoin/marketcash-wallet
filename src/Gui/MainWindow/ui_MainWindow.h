...
public:
    ...
    QAction *m_aboutMarketCashAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/marketcash"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutMarketCashAction = new QAction(MainWindow);
        m_aboutMarketCashAction->setObjectName(QStringLiteral("m_aboutMarketCashAction"));
        m_aboutMarketCashAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutMarketCashAction);
        ...
        QObject::connect(m_aboutMarketCashAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutMarketCashAction->setText(QApplication::translate("MainWindow", "About MarketCash", 0));
        ...
        m_walletLabel->setText(QApplication::translate("MainWindow", "Your MarketCash wallet:", 0));
#ifndef QT_NO_TOOLTIP
